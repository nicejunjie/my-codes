...
const double lscale_nc = 0.7001890359168242,lscale_cn=0.7860113421550093,lscale_cc=0.7238857938718662;
...
const std::string s_getF=" sed -n '/Forces (Hartrees/,/Cartesian/ p' | egrep -vi '[a-z]|--'|awk '{print $3,$4,$5}' ";
const std::string s_getQ=" sed -n '/Mulliken charges:/,/Sum of Mulliken/ p' | head -n -1 | tail -n +3| awk '{print $3}' ";
//string s_getD=" sed -n '/Dipole moment/, +1 p' | tail -1 | awk '{print $2 ,$4 ,$6 }' ";
const std::string s_getD=" egrep -i '^ *Dipole  *=' | sed 's/-/ -/g' | sed 's/D /E/g'|awk '{print $3,$4,$5}' ";
